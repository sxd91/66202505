...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "1537249820", // 在此处设置你的Bilibili用户ID (vmid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "66中毕业相册", // 主页横幅主标题

			subtitle: [
				"Tips:欢迎来到 66 中五班毕业相册",
				"Tips:只要地球不爆炸，我们就不停维",
				"Tips:别看我了看看其他的吧",
				"Tips:请输入文本",
				"Tips:何意位",
...
export const profileConfig: ProfileConfig = {
	avatar: "https://img.wjwj.top/2026/04/06/077fb7d54385cd11272331b1c26e17ae.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "舒玺达",
	bio: "请输入文本",
	typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://dazzling-kashata-95c4e1.netlify.app/.netlify/functions/twikoo",
		lang: SITE_LANG,
	},
};
